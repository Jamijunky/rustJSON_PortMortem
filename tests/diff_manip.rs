...
unsafe extern "C" {
    ...
    fn ref_cJSON_CreateNull() -> *mut CJson;
    fn ref_cJSON_CreateTrue() -> *mut CJson;
    fn ref_cJSON_AddItemToArray(array: *mut CJson, item: *mut CJson) -> c_int;
    fn ref_cJSON_AddItemToObjectCS(
        object: *mut CJson,
        string: *const c_char,
        item: *mut CJson,
    ) -> c_int;
    fn ref_cJSON_AddItemReferenceToArray(array: *mut CJson, item: *mut CJson) -> c_int;
    fn ref_cJSON_AddItemReferenceToObject(
        object: *mut CJson,
        string: *const c_char,
        item: *mut CJson,
    ) -> c_int;
    fn ref_cJSON_AddNullToObject(object: *mut CJson, name: *const c_char) -> *mut CJson;
    fn ref_cJSON_AddTrueToObject(object: *mut CJson, name: *const c_char) -> *mut CJson;
    fn ref_cJSON_AddFalseToObject(object: *mut CJson, name: *const c_char) -> *mut CJson;
    fn ref_cJSON_AddBoolToObject(
        object: *mut CJson,
        name: *const c_char,
        boolean: c_int,
    ) -> *mut CJson;
    ...
    fn ref_cJSON_AddRawToObject(
        object: *mut CJson,
        name: *const c_char,
        raw: *const c_char,
    ) -> *mut CJson;
    fn ref_cJSON_AddObjectToObject(object: *mut CJson, name: *const c_char) -> *mut CJson;
    fn ref_cJSON_AddArrayToObject(object: *mut CJson, name: *const c_char) -> *mut CJson;
    fn ref_cJSON_GetArraySize(array: *const CJson) -> c_int;
    ...
    fn ref_cJSON_GetObjectItemCaseSensitive(
        object: *const CJson,
        string: *const c_char,
    ) -> *mut CJson;
    ...
    fn ref_cJSON_DetachItemFromObject(object: *mut CJson, string: *const c_char) -> *mut CJson;
    fn ref_cJSON_DeleteItemFromObject(object: *mut CJson, string: *const c_char);
    fn ref_cJSON_DeleteItemFromObjectCaseSensitive(object: *mut CJson, string: *const c_char);
    fn ref_cJSON_InsertItemInArray(array: *mut CJson, which: c_int, newitem: *mut CJson) -> c_int;
    fn ref_cJSON_ReplaceItemInArray(array: *mut CJson, which: c_int, newitem: *mut CJson) -> c_int;
    fn ref_cJSON_ReplaceItemInObject(
        object: *mut CJson,
        string: *const c_char,
        newitem: *mut CJson,
    ) -> c_int;
    fn ref_cJSON_ReplaceItemInObjectCaseSensitive(
        object: *mut CJson,
        string: *const c_char,
        newitem: *mut CJson,
    ) -> c_int;
    fn ref_cJSON_Duplicate(item: *const CJson, recurse: c_int) -> *mut CJson;
    fn ref_cJSON_Compare(a: *const CJson, b: *const CJson, case_sensitive: c_int) -> c_int;
    fn ref_cJSON_Minify(json: *mut c_char);
    fn ref_cJSON_SetValuestring(object: *mut CJson, valuestring: *const c_char) -> *mut c_char;
    fn ref_cJSON_SetNumberHelper(object: *mut CJson, number: c_double) -> c_double;
    fn ref_cJSON_GetStringValue(item: *const CJson) -> *mut c_char;
    fn ref_cJSON_GetNumberValue(item: *const CJson) -> c_double;
    fn ref_cJSON_IsInvalid(item: *const CJson) -> c_int;
    fn ref_cJSON_IsNull(item: *const CJson) -> c_int;
    fn ref_cJSON_IsNumber(item: *const CJson) -> c_int;
    fn ref_cJSON_IsString(item: *const CJson) -> c_int;
    fn ref_cJSON_IsArray(item: *const CJson) -> c_int;
    fn ref_cJSON_IsObject(item: *const CJson) -> c_int;
    fn ref_cJSON_Version() -> *const c_char;
...
fn differential_manip_scripted() {
    with_lock(|| {
        ...
        run_both(
            || {
                (unsafe { cjson_create_object() }, unsafe {
                    ref_cJSON_CreateObject()
                })
            },
        ...
        run_both(
            ...
            |o, c| unsafe {
                ...
                assert_same_null(
                    cjson_add_number_to_object(o, k.as_ptr() as *const c_char, 1.5),
                    ref_cJSON_AddNumberToObject(c, k.as_ptr() as *const c_char, 1.5),
                    "add_number",
                );
                ...
                assert_same_null(
                    cjson_add_string_to_object(
                        ...
                        cstr_buf(b"hi").as_ptr() as *const c_char,
                    ),
                ...
                assert_same_null(
                    cjson_add_null_to_object(o, k.as_ptr() as *const c_char),
                    ref_cJSON_AddNullToObject(c, k.as_ptr() as *const c_char),
                    "add_null",
                );
                let k = cstr_buf(b"t");
                assert_same_null(
                    cjson_add_true_to_object(o, k.as_ptr() as *const c_char),
                    ref_cJSON_AddTrueToObject(c, k.as_ptr() as *const c_char),
                    "add_true",
                );
                let k = cstr_buf(b"f");
                assert_same_null(
                    cjson_add_false_to_object(o, k.as_ptr() as *const c_char),
                    ref_cJSON_AddFalseToObject(c, k.as_ptr() as *const c_char),
                    "add_false",
                );
                let k = cstr_buf(b"b");
                assert_same_null(
                    cjson_add_bool_to_object(o, k.as_ptr() as *const c_char, 0),
                    ref_cJSON_AddBoolToObject(c, k.as_ptr() as *const c_char, 0),
                    "add_bool",
                );
                let k = cstr_buf(b"raw");
                assert_same_null(
                    cjson_add_raw_to_object(
                        o,
                        k.as_ptr() as *const c_char,
                        cstr_buf(b"1e3").as_ptr() as *const c_char,
                    ),
                    ref_cJSON_AddRawToObject(
                        c,
                        k.as_ptr() as *const c_char,
                        cstr_buf(b"1e3").as_ptr() as *const c_char,
                    ),
                ...
                assert_same_null(
                    cjson_add_object_to_object(o, k.as_ptr() as *const c_char),
                    ref_cJSON_AddObjectToObject(c, k.as_ptr() as *const c_char),
                    "add_object",
                );
                let k = cstr_buf(b"arr");
                assert_same_null(
                    cjson_add_array_to_object(o, k.as_ptr() as *const c_char),
                    ref_cJSON_AddArrayToObject(c, k.as_ptr() as *const c_char),
                    "add_array",
                );
            },
            "build-object",
        ...
        run_both(
            || {
                (unsafe { cjson_create_array() }, unsafe {
                    ref_cJSON_CreateArray()
                })
            },
            |o, c| unsafe {
                for i in 0..12 {
                    assert_eq!(
                        ...
                        ref_cJSON_AddItemToArray(c, ref_cJSON_CreateNumber(i as c_double)),
                        "add_item_to_array {i}"
                    );
                }
                assert_eq!(cjson_get_array_size(o), ref_cJSON_GetArraySize(c));
                // add a reference to element 3
                let el = cjson_get_array_item(o, 3);
                assert_eq!(
                    cjson_add_item_reference_to_array(o, el),
                    ref_cJSON_AddItemReferenceToArray(c, ref_cJSON_GetArrayItem(c, 3))
                );
                assert_eq!(cjson_get_array_size(o), ref_cJSON_GetArraySize(c));
            },
            "build-array",
        ...
        run_both(
            || {
                ...
                let c = unsafe { ref_cJSON_CreateObject() };
                unsafe {
                    for i in 0..10 {
                        let name = cstr_buf(format!("k{i}").as_bytes());
                        cjson_add_number_to_object(
                            o,
                            name.as_ptr() as *const c_char,
                            i as c_double,
                        );
                        ref_cJSON_AddNumberToObject(
                            c,
                            name.as_ptr() as *const c_char,
                            i as c_double,
                        );
                    ...
                    ref_cJSON_AddArrayToObject(c, name.as_ptr() as *const c_char);
                    let arr_o = cjson_get_object_item(o, name.as_ptr() as *const c_char);
                    let arr_c = ref_cJSON_GetObjectItem(c, name.as_ptr() as *const c_char);
                    for i in 0..5 {
                        cjson_add_item_to_array(arr_o, cjson_create_number(i as c_double));
                        ref_cJSON_AddItemToArray(arr_c, ref_cJSON_CreateNumber(i as c_double));
                    }
                }
                (o, c)
            },
            |o, c| unsafe {
                ...
                ref_cJSON_DeleteItemFromArray(arr_c, 2);
                ...
                let det_c = ref_cJSON_DetachItemFromObject(c, k3.as_ptr() as *const c_char);
                assert_eq!(det_o.is_null(), det_c.is_null(), "detach nullness");
                cjson_delete(det_o);
                ref_cJSON_Delete(det_c);
                ...
                let n_c = ref_cJSON_CreateString(cstr_buf(b"replaced").as_ptr() as *const c_char);
                assert_eq!(
                    cjson_replace_item_in_array(arr_o, 0, n_o),
                    ref_cJSON_ReplaceItemInArray(arr_c, 0, n_c),
                ...
                let i_c = ref_cJSON_CreateNumber(99.0);
                assert_eq!(
                    cjson_insert_item_in_array(arr_o, 1, i_o),
                    ref_cJSON_InsertItemInArray(arr_c, 1, i_c),
                ...
                assert_eq!(
                    cjson_replace_item_in_object(
                        o,
                        k7.as_ptr() as *const c_char,
                        cjson_create_null()
                    ),
                    ref_cJSON_ReplaceItemInObject(
                        c,
                        k7.as_ptr() as *const c_char,
                        ref_cJSON_CreateNull()
                    ),
                ...
                assert_eq!(
                    cjson_replace_item_in_object_case_sensitive(
                        o,
                        k9.as_ptr() as *const c_char,
                        cjson_create_true()
                    ),
                    ref_cJSON_ReplaceItemInObjectCaseSensitive(
                        c,
                        k9.as_ptr() as *const c_char,
                        ref_cJSON_CreateTrue()
                    ),
                ...
                let got_c = ref_cJSON_GetObjectItem(c, mix.as_ptr() as *const c_char);
                assert_eq!(got_o.is_null(), got_c.is_null());
                let got_cs_o =
                    cjson_get_object_item_case_sensitive(o, mix.as_ptr() as *const c_char);
                let got_cs_c =
                    ref_cJSON_GetObjectItemCaseSensitive(c, mix.as_ptr() as *const c_char);
                assert_eq!(
                    got_cs_o.is_null(),
                    got_cs_c.is_null(),
                    "case sensitive should miss K0"
                );

                // SetValuestring on a string
                let kstr = cstr_buf(b"str");
                let sv_o = cjson_get_object_item(o, kstr.as_ptr() as *const c_char);
                let sv_c = ref_cJSON_GetObjectItem(c, kstr.as_ptr() as *const c_char);
                if !sv_o.is_null() {
                    let newv = cstr_buf(b"changed!longer");
                    let r_o = cjson_set_valuestring(sv_o, newv.as_ptr() as *const c_char);
                    let r_c = ref_cJSON_SetValuestring(sv_c, newv.as_ptr() as *const c_char);
                ...
                let sn_c = ref_cJSON_GetObjectItem(c, knum.as_ptr() as *const c_char);
                if !sn_o.is_null() {
                    assert_eq!(
                        cjson_set_number_helper(sn_o, 2.75),
                        ref_cJSON_SetNumberHelper(sn_c, 2.75),
                        "set_number_helper"
                    );
                }
                ...
                let ref_c = ref_cJSON_GetObjectItem(c, ka.as_ptr() as *const c_char);
                let kn = cstr_buf(b"ref");
                assert_eq!(
                    cjson_add_item_reference_to_object(o, kn.as_ptr() as *const c_char, ref_o),
                    ref_cJSON_AddItemReferenceToObject(c, kn.as_ptr() as *const c_char, ref_c),
                ...
                let item_c = ref_cJSON_CreateString(cstr_buf(b"cs").as_ptr() as *const c_char);
                assert_eq!(
                    cjson_add_item_to_object_cs(o, kcs.as_ptr() as *const c_char, item_o),
                    ref_cJSON_AddItemToObjectCS(c, kcs.as_ptr() as *const c_char, item_c),
    ...
    with_lock(|| {
        ...
        for case in cases {
            ...
            unsafe {
                ...
                ref_cJSON_Minify(b.as_mut_ptr() as *mut c_char);
            }
            assert_eq!(
...
fn differential_predicates() {
    with_lock(|| {
        ...
        let ac = unsafe { ref_cJSON_CreateArray() };
        let n = unsafe { cjson_create_number(3.0) };
        let nc = unsafe { ref_cJSON_CreateNumber(3.0) };
        let s = unsafe { cjson_create_string(cstr_buf(b"x").as_ptr() as *const c_char) };
        let sc = unsafe { ref_cJSON_CreateString(cstr_buf(b"x").as_ptr() as *const c_char) };
        unsafe {
            assert_eq!(cjson_is_object(o), ref_cJSON_IsObject(c));
            assert_eq!(cjson_is_array(a), ref_cJSON_IsArray(ac));
            assert_eq!(cjson_is_number(n), ref_cJSON_IsNumber(nc));
            assert_eq!(cjson_is_string(s), ref_cJSON_IsString(sc));
            assert_eq!(cjson_is_invalid(o), ref_cJSON_IsInvalid(c));
            assert_eq!(cjson_is_null(o), ref_cJSON_IsNull(c));
            // accessors
            assert_eq!(cjson_get_number_value(n), ref_cJSON_GetNumberValue(nc));
            assert_eq!(
                cstr_bytes(cjson_get_string_value(s)),
                cstr_bytes(ref_cJSON_GetStringValue(sc))
            );
            // version
            assert_eq!(cstr_bytes(cjson_version()), cstr_bytes(ref_cJSON_Version()));
            // GetArrayItem on NULL array / out of range
            assert_eq!(
                cjson_get_array_item(ptr::null(), 0).is_null(),
                ref_cJSON_GetArrayItem(ptr::null(), 0).is_null()
            );
            assert_eq!(
                cjson_get_array_item(a, 0).is_null(),
                ref_cJSON_GetArrayItem(ac, 0).is_null()
            );
            assert_eq!(
                cjson_get_array_item(a, -1).is_null(),
                ref_cJSON_GetArrayItem(ac, -1).is_null()
            );
            // GetNumberValue on non-number (NAN)
            assert_eq!(
                cjson_get_number_value(o).is_nan(),
                ref_cJSON_GetNumberValue(c).is_nan()
            );
        }
        unsafe {
            cjson_delete(o);
...
fn random_mutate(rng: &mut Rng, o: *mut CJson, c: *mut CJson) {
    unsafe {
        ...
        let osize = ref_cJSON_GetArraySize(c) as usize;
        ...
        match rng.below(12) {
            0 => {
                ...
                assert_same_null(
                    ...
                    ref_cJSON_AddNumberToObject(c, name.as_ptr() as *const c_char, newnum),
                    "fuzz add_number",
                );
            }
            1 => {
            ...
            2 => {
                ...
                assert_same_null(
                    ...
                    ref_cJSON_AddBoolToObject(c, name.as_ptr() as *const c_char, rbool),
                    "fuzz add_bool",
                );
            }
            3 => {
                ...
                assert_same_null(
                    cjson_add_raw_to_object(
                        o,
                        name.as_ptr() as *const c_char,
                        cstr_buf(b"1234").as_ptr() as *const c_char,
                    ),
                    ref_cJSON_AddRawToObject(
                        c,
                        name.as_ptr() as *const c_char,
            ...
            5 => {
                ...
                assert_same_null(
                    ...
                    ref_cJSON_AddObjectToObject(c, name.as_ptr() as *const c_char),
                    "fuzz add_object",
                );
            }
            6 => {
                ...
                assert_eq!(
                    ...
                    ref_cJSON_AddItemToArray(c, ref_cJSON_CreateNumber(newnum))
                );
            }
            7 => {
            ...
            10 => {
                ...
                if size > 0 {
                    assert_eq!(
                        cjson_replace_item_in_array(
                            o,
                            idx as c_int,
                            cjson_create_string(name.as_ptr() as *const c_char)
                        ),
                        ref_cJSON_ReplaceItemInArray(
                            c,
                            idx as c_int,
                            ref_cJSON_CreateString(name.as_ptr() as *const c_char)
                        )
                    );
                }
            }
            11 => {
                ...
                assert_eq!(
                    ...
                    ref_cJSON_InsertItemInArray(c, idx as c_int, ref_cJSON_CreateNumber(newnum))
                );
            }
            _ => unreachable!(),
        }
...
fn differential_manip_fuzz() {
    with_lock(|| {
        ...
        unsafe {
            ...
            ref_cJSON_AddArrayToObject(c, na.as_ptr() as *const c_char);
            let arr_o = cjson_get_object_item(o, na.as_ptr() as *const c_char);
            let arr_c = ref_cJSON_GetObjectItem(c, na.as_ptr() as *const c_char);
            for i in 0..8 {
                cjson_add_item_to_array(arr_o, cjson_create_number(i as c_double));
                ref_cJSON_AddItemToArray(arr_c, ref_cJSON_CreateNumber(i as c_double));
            }
        ...
        for step in 0..5000u64 {
            ...
            if step % 500 == 0 {
                ...
                let d_c = unsafe { ref_cJSON_Duplicate(c, 1) };
                assert!(!d_o.is_null() && !d_c.is_null());
                assert_eq!(unsafe { cjson_compare(o, d_o, 1) }, unsafe {
                    ref_cJSON_Compare(c, d_c, 1)
                });
                assert_print_eq(d_o, d_c, "fuzz duplicate");
                unsafe {
                    cjson_delete(d_o);
                    ref_cJSON_Delete(d_c);
                }
            }
